 ...
 * <p>提示某个 {@link EnableAutoConfiguration 自动配置} 应在其他指定的自动配置类之后应用。</p>
 *
 * <p>
...
public @interface AutoConfigureAfter {
	 ...
	 * <p>应已经应用的自动配置类的名称。在自动配置类不是顶级类的特殊情况下，其类名应使用 {@code $} 将其与包含类分隔，例如 {@code com.example.Outer$NestedAutoConfiguration}。</p>
	 *
