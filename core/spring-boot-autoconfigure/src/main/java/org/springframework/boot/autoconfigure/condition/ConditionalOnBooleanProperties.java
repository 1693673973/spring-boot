 ...
 * <p>用于聚合多个 {@link ConditionalOnBooleanProperty @ConditionalOnBooleanProperty} 注解的容器注解。</p>
 *
 * @author Phillip Webb
 * @since 3.5.0
...
public @interface ConditionalOnBooleanProperties {
	 ...
	 * {@link ConditionalOnBooleanProperty @ConditionalOnBooleanProperty} annotations.
	 * <p>返回包含的 {@link ConditionalOnBooleanProperty @ConditionalOnBooleanProperty} 注解。</p>
	 *
